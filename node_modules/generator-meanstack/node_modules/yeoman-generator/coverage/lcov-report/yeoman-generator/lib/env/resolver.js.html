...
<html lang="en">
<head>
    <title>Code coverage report for yeoman-generator/lib/env/resolver.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">yeoman-generator/lib/env/resolver.js</span></h1>
    <h2>
        
        Statements: <span class="metric">82.61% <small>(38 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">84.44% <small>(38 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">yeoman-generator/lib/env/</a> &#187; resolver.js</div>
</div>
<div class="body">
...
&nbsp;
  nodeModules.forEach(function (root) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!root) <span class="cstat-no" title="statement not covered" >return;</span>
...
<span class="cstat-no" title="statement not covered" >    console.error('Unable to register %s (Error: %s)', generatorReference, e.message);</span>
  }
};
&nbsp;
/**
...
exports.alias = function alias(match, value) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (match &amp;&amp; value) {
<span class="cstat-no" title="statement not covered" >    this.aliases.push({</span>
...
&nbsp;
  var matcher = aliases.filter(<span class="fstat-no" title="function not covered" >function (alias) {</span>
<span class="cstat-no" title="statement not covered" >    return alias.match.test(match);</span>
  });
&nbsp;
  return aliases.reduce(<span class="fstat-no" title="function not covered" >function (res, alias) {</span>
<span class="cstat-no" title="statement not covered" >    if (!alias.match.test(res)) {</span>
<span class="cstat-no" title="statement not covered" >      return res;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return res.replace(alias.match, alias.value);</span>
  }, match);
};
&nbsp;</pre></td></tr>
</table></pre>
