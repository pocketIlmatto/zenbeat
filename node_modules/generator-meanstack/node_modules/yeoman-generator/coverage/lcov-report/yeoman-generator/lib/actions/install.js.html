...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">79.31% <small>(23 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  options = options || {};
  cb = cb || function () {};
  paths = Array.isArray(paths) ? <span class="branch-0 cbranch-no" title="branch not covered" >paths </span>: (paths &amp;&amp; paths.split(' ') || []);
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (msg.commands.length === 0) {
<span class="cstat-no" title="statement not covered" >    throw new Error('installDependencies needs at least one of npm or bower to run.');</span>
  }
&nbsp;
