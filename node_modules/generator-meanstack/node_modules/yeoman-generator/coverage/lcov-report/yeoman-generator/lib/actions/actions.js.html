...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">88.33% <small>(159 / 180)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">74.29% <small>(52 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">92.31% <small>(24 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">88.33% <small>(159 / 180)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  ...
  var home = process.env[process.platform === 'win32' ? <span class="branch-0 cbranch-no" title="branch not covered" >'USERPROFILE' </span>: 'HOME'];
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (encoding !== null) {
      contents = iconv.decode(contents, encoding || 'utf8');
&nbsp;
      // strip any BOM that might exist.
      <span class="missing-if-branch" title="if path not taken" >I</span>if (contents.charCodeAt(0) === 0xFEFF) {
<span class="cstat-no" title="statement not covered" >        contents = contents.substring(1);</span>
      }
    }
&nbsp;
    return contents;
  } catch (e) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Unable to read "' + filepath + '" file (Error code: ' + e.code + ').');</span>
  }
};
&nbsp;
/**
...
&nbsp;
    // create or force means file write, identical or skip prevent the
    // actual write
    <span class="missing-if-branch" title="else path not taken" >E</span>if (/force|create/.test(config.status)) {
...
&nbsp;
  this.conflicter.once('resolved:' + filepath, function (config) {
    ...
    var queue = (typeof setImmediate === 'function') ? setImmediate : <span class="branch-1 cbranch-no" title="branch not covered" >process.nextTick;</span>
...
<span class="cstat-no" title="statement not covered" >      self.tarball(url, cache, done);</span>
    }
  });
&nbsp;
  function done(err) {
...
&nbsp;
    ...
    remote.template = <span class="fstat-no" title="function not covered" >function template(source, destination, data) {</span>
