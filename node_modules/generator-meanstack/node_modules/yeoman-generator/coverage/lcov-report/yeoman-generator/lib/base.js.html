...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">94.33% <small>(233 / 247)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">76.69% <small>(102 / 133)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">95.45% <small>(42 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">94.33% <small>(233 / 247)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
708
709
710</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  this.args = this.arguments = args || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
  this.options = options || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
  // checks required paramaters
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.options.env) {
<span class="cstat-no" title="statement not covered" >    throw new Error('You must provide the environment object. Use env#create() to create a new generator.');</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.options.resolved) {
<span class="cstat-no" title="statement not covered" >    throw new Error('You must provide the resolved path value. Use env#create() to create a new generator.');</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!opt) {
    this._options.push(config);
  } else {
<span class="cstat-no" title="statement not covered" >    opt = config;</span>
  }
&nbsp;
...
Base.prototype.argument = function argument(name, config) {
  ...
  _.defaults(config, {
    name: name,
    required: config.defaults == null ? true : <span class="branch-1 cbranch-no" title="branch not covered" >false,</span>
    type: String
  });
&nbsp;
...
&nbsp;
  ...
  this._arguments.forEach(function (arg, i) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (position !== -1) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (arg.name === name) {
      position = i;
    }
  });
&nbsp;
...
&nbsp;
    return function (next) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!rules.valid()) {
...
&nbsp;
  var resolve = function (hook) {
    ...
    var context = hook.as || self.resolved || <span class="branch-2 cbranch-no" title="branch not covered" >self.generateName;</span>
    var options = _.clone(hook.options || self.options);
    options.args = _.clone(hook.args || self.args);
&nbsp;
    return function (next) {
      self.invoke(resolved + (context ? ':' + context : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>, options, next);
    };
  };
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._running) {
<span class="cstat-no" title="statement not covered" >    return this.emit('error', new Error(</span>
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (config &amp;&amp; config[name]) {
<span class="cstat-no" title="statement not covered" >    name = config[name];</span>
  }
&nbsp;
  return name;
};
...
Base.prototype.bannerFor = function bannerFor(config) {
  return config.type === Boolean ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>:
    config.type === String ? config.name.toUpperCase() :
    config.type === Number ? 'N' :
    config.type === Object ? <span class="branch-0 cbranch-no" title="branch not covered" >'key:value' </span>:
...
&nbsp;
  // build options
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this._options.length) {
    out = out.concat([
      'Options:',
      this.optionsHelp(),
      ''
...
Base.prototype.argumentsHelp = function argumentsHelp() {
  var rows = this._arguments.map(function (a) {
    return [
      '',
      a.name ? a.name : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
      a.config.type ? '# Type: ' + a.config.type.name : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
...
&nbsp;
  var rows = options.concat(hookOpts).map(function (o) {
    return [
      ...
      o.alias ? '-' + o.alias + ', ' : '',
      '--' + o.name,
      o.desc ? '# ' + o.desc : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
      o.defaults == null ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: 'Default: ' + o.defaults
    ];
  });
&nbsp;
  return this.log.table({
...
Base.prototype.rootGeneratorName = function () {
  ...
  return path ? JSON.parse(fs.readFileSync(path, 'utf8')).name : <span class="branch-1 cbranch-no" title="branch not covered" >'*';</span>
};
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >        config.callback(err);</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Jan 01 2014 15:07:51 GMT-0500 (EST)</div>
</div>
