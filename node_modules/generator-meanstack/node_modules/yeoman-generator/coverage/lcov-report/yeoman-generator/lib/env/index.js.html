...
<html lang="en">
<head>
    <title>Code coverage report for yeoman-generator/lib/env/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">yeoman-generator/lib/env/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.74% <small>(144 / 152)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">83.75% <small>(67 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">yeoman-generator/lib/env/</a> &#187; index.js</div>
</div>
<div class="body">
...
Environment.prototype.error = function error(err) {
  err = err instanceof Error ? err : <span class="branch-1 cbranch-no" title="branch not covered" >new Error(err);</span>
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.emit('error', err)) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (win32) {
<span class="cstat-no" title="statement not covered" >    this.appendPath(path.join(process.env.APPDATA, 'npm/node_modules'));</span>
  } else {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!groups[base]) {
      groups[base] = [];
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (group.length &gt;= 1) {
...
Environment.prototype.register = function register(name, namespace) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!_.isString(name)) {
<span class="cstat-no" title="statement not covered" >    return this.error(new Error('You must provide a generator name to register.'));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return this.error(new Error('Unable to determine namespace.'));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return this.error(new Error('Must provide at least one argument, the generator namespace to invoke.'));</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.help) {
<span class="cstat-no" title="statement not covered" >    return console.log(generator.help());</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Missing namespace');</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (moduleId[0] === '~') {
<span class="cstat-no" title="statement not covered" >    moduleId = process.env[process.platform === 'win32' ? 'USERPROFILE' : 'HOME'] + moduleId.slice(1);</span>
  }
&nbsp;
