...
<div class="header medium">
    ...
    <h2>
        ...
        Branches: <span class="metric">41.67% <small>(10 / 24)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">66.67% <small>(18 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">68.69% <small>(68 / 99)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
helpers.assertFile = <span class="fstat-no" title="function not covered" >function (file, reg) {</span>
<span class="cstat-no" title="statement not covered" >  var here = fs.existsSync(file);</span>
<span class="cstat-no" title="statement not covered" >  assert.ok(here, file + ', no such file or directory');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!reg) {</span>
<span class="cstat-no" title="statement not covered" >    return assert.ok(here);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var body = fs.readFileSync(file, 'utf8');</span>
<span class="cstat-no" title="statement not covered" >  assert.ok(reg.test(body), file + ' did not match \'' + reg + '\'.');</span>
};
&nbsp;
...
//
helpers.assertFiles = <span class="fstat-no" title="function not covered" >function (files) {</span>
...
<span class="cstat-no" title="statement not covered" >    var file = item;</span>
<span class="cstat-no" title="statement not covered" >    var rx;</span>
<span class="cstat-no" title="statement not covered" >    if (item instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >      file = item[0];</span>
<span class="cstat-no" title="statement not covered" >      rx = item[1];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    helpers.assertFile(file, rx);</span>
  });
};
&nbsp;
...
helpers.assertImplement = function (obj, methods) {
  methods = _.isArray(methods) ? <span class="branch-0 cbranch-no" title="branch not covered" >methods </span>: Object.keys(methods);
  var pass = methods.reduce(function (rest, method) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (obj[method] != null) return true;
...
//
helpers.testDirectory = <span class="fstat-no" title="function not covered" >function (dir, cb) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  rimraf(dir, <span class="fstat-no" title="function not covered" >function (err) {</span></span>
...
//
helpers.mockPrompt = <span class="fstat-no" title="function not covered" >function (generator, answers) {</span>
<span class="cstat-no" title="statement not covered" >  var origPrompt = generator.prompt;</span>
<span class="cstat-no" title="statement not covered" >  generator.prompt = <span class="fstat-no" title="function not covered" >function (prompts, done) {</span></span>
<span class="cstat-no" title="statement not covered" >    done(answers);</span>
  };
<span class="cstat-no" title="statement not covered" >  generator.origPrompt = origPrompt;</span>
};
&nbsp;
//
...
helpers.createGenerator = function (name, dependencies, args, options) {
  ...
  dependencies.forEach(function (d) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (d instanceof Array) {
      env.registerStub(d[0], d[1]);
    } else {
<span class="cstat-no" title="statement not covered" >      env.register(d);</span>
    }
  });
&nbsp;
...
&nbsp;
  generator.on('method', <span class="fstat-no" title="function not covered" >function (method) {</span>
<span class="cstat-no" title="statement not covered" >    env.emit(name + ':' + method);</span>
  });
&nbsp;
